...
SCENES = {
    ...
    "overnight": {
        "title": "Dezh: a coding agent loose overnight, and the morning it is accounted for",
        "caption": "console session, verbatim from docs/transcripts/overnight.md",
        "lines": [
            ("prompt", "overnight"),
            ("dim", "[overnight] you leave a coding agent loose overnight under ONE intent;"),
            ("dim", "            in the morning you account for and undo its night"),
            ("", ""),
            ("dim", "[overnight] 1/6 opened the agent's intent Ahd#8 (a writer ceiling) and turned it loose"),
            ("dim", "[overnight] 2/6 the agent's night: an irreversible deploy + two reversible writes"),
            ("dim", "            (ns=lab), one compensatable external action (ns=calc)"),
            ("", ""),
            ("dim", "[overnight] 3/6 morning: FORECAST the rollback before touching anything"),
            ("warn", "  [sfar] plan: reversible=2 compensatable=1 irreversible=1 unknown=0"),
            ("warn", "         confidence=partial (some effects cannot be undone)"),
            ("dim", "  [tbar] 4 effect(s) attributed to intent Ahd#8"),
            ("", ""),
            ("dim", "[overnight] 4/6 undo the night honestly"),
            ("bad", "    [sfar] REFUSED at ns=lab slot=19: irreversible effect already happened"),
            ("bad", "           in the outside world; cannot be undone"),
            ("ok", "    [sfar] COMPENSATED at ns=calc slot=22: ran compensating action"),
            ("ok", "           \"revoke api-key:tmp/42\" recorded as effect slot=23"),
            ("ok", "  [sfar] mission Ahd#8 rolled back: reversible effects retracted=2"),
            ("ok", "         compensations performed=1 refused_irreversible=1"),
            ("", ""),
            ("dim", "[overnight] 5/6 the agent also TRIED to escape its intent (a write beyond the ceiling)"),
            ("warn", "[redteam] beyond-intent dropped by the derivation ceiling: cairn-read cairn-write"),
            ("dim", "[why-denied] boundary: intent-derivation ceiling (derived cap <= Ahd), enforced in the kernel"),
            ("", ""),
            ("pass", "[overnight] PASS: the whole night is accounted for - reversibles undone,"),
            ("pass", "            the compensatable action compensated, the irreversible deploy"),
            ("pass", "            refused with a reason, and the escape contained"),
        ],
    },
    "sfar": {
